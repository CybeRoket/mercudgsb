...
<body <?php body_class();?>>
    ...
    <header class="sticky-top">
        <div class="header-container">
            <div class="site-logo-container container d-flex justify-content-center align-items-center">
                <a href="<?php get_option("siteurl"); ?>" class="site-logo">
            ...
            <?php
                wp_nav_menu( array(
                    ...
                    'depth'             => 2,
                    'container'         => 'div',
                    'container_class'   => 'header-menu navbar navbar-expand-lg navbar-light d-flex justify-content-center',
                    'container_id'      => '',
                    'menu_class'        => 'header-menu-ul navbar-nav',
